...
class App(CTk.CTk):
    def __init__(self):
        ...
        #кнопка директории
        self.directory_button = CTk.CTkButton(master=self.Buttons_frame, width=30, height=45, fg_color='#088f00', hover_color='#087301', corner_radius=13, border_width=0, image=add_info_image, text="", command=lambda: print())

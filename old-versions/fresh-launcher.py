...
class App(CTk.CTk):
    def __init__(self):
        ...
        add_settings_image = CTk.CTkImage(dark_image=Image.open("../images/settings_icon.png"),
                                          light_image=Image.open("../images/settings_icon.png"), size=(37, 37))

        add_info_image = CTk.CTkImage(dark_image=Image.open("../images/info_icon.png"),
                                      light_image=Image.open("../images/info_icon.png"), size=(37, 37))
        ...
        #меню выбора версий
        self.version_menu = CTk.CTkComboBox(self.ui_frame, corner_radius=13, font=("JetBrains Mono Medium", 20), width=220, height=50, values=versionsId)
